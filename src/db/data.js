...
const db = [
    {
        ...
        category: 'web',
        name: 'Responsive',
        description: 'Responsive is a web component library using the Web Components API. The purpose is to utilize and compare native web technologies with popular frameworks like React, Angular, and Vue.',
        links: {
    ...
    },
    {
        ...
        category: 'web',
        name: 'Audiophile',
        description: "Audiophile is as fully responsive prototype e-commerce website, offering users the ability to explore an array of headphones and speakers. \n\n Next.js 13.4, SCSS, and Typescript.",
        links: {
