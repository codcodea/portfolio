...
const db = [
    ...
    },
    {
        ...
        category: 'web',
        name: 'CMS website',
        description: "WiMats.se is website for a local company. It is built using Wordpress allowing access to client- and content management.",
        links: {
